...
.inputBox{position:absolute;bottom:40px;width:100%;text-align:center}
.inputBox input{width:60%;background:black;border:1px solid #00e5ff;color:#8ff7ff;padding:10px;outline:none}
</style>
</head>
...
<div class="inputBox"><input id="textInput" placeholder="Type command…" /></div>
</div>
</div>
